...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/fig7_leaf_benchmarks.png}
\caption{Cross-dataset LEAF benchmark accuracy comparison on (a) FEMNIST 62-class CNN and (b) Shakespeare character recurrent LSTM.}
\label{fig:leaf_benchmarks}
\end{figure}
