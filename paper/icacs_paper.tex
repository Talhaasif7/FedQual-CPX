...
% PLACEHOLDER: Fig. 1 Architecture Overview
\begin{figure}[t]
\centering
...
% PLACEHOLDER: Fig. 2 Detection and Adaptation Flow
\begin{figure}[t]
\centering
...
\begin{itemize}
    \item \textbf{CIFAR-10:} Fifty thousand training images across ten image categories. Non-IID partitions follow Dirichlet distribution with concentration $\alpha = 0.5$ across $N=100$ clients.
    \item \textbf{LEAF FEMNIST:} Sixty-two handwritten character classes based on Caldas et al. [5], capturing realistic user handwriting variations across natural non-IID splits.
    \item \textbf{LEAF Shakespeare:} Recurrent character-level dialogue prediction across speaking roles with a vocabulary of ninety tokens [5].
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Participation Gini Index:} Gini inequality of client selection counts, where zero means perfect equality and one means total monopoly.
...
\begin{enumerate}
    ...
    \item[4.] E. S. Page, ``Continuous inspection schemes,'' \textit{Biometrika}, vol. 41, no. 1/2, pp. 100--115, 1954.
    \item[5.] S. Caldas, S. M. K. Duddu, P. Wu, T. Li, J. Kone{\v{c}}n{\`y}, H. B. McMahan, V. Smith, and A. Talwalkar, ``LEAF: A benchmark for federated settings,'' \textit{arXiv:1812.01097}, 2018.
    \item[6.] P. J. Huber, \textit{Robust Statistics}. New York, NY: John Wiley \& Sons, 1981.
    \item[7.] M. Basseville and I. V. Nikiforov, \textit{Detection of Abrupt Changes: Theory and Application}. Englewood Cliffs, NJ: Prentice-Hall, 1993.
    \item[8.] P. Kairouz, H. B. McMahan, B. Avent, A. Bellet, M. Bennis, A. N. Bhagoji, et al., ``Advances and open problems in federated learning,'' \textit{Found. Trends Mach. Learn.}, vol. 14, no. 1--2, pp. 1--210, 2021.
    \item[9.] C. Gini, ``Variabilit\`a e mutabilit\`a,'' \textit{Reprinted in Memorie di metodologica statistica}, 1912.
